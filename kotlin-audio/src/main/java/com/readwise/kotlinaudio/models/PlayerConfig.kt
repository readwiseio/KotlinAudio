...
data class PlayerConfig(
     ...
     *
     * Setting this to true enables the use of [onPlayerActionTriggeredExternally][com.readwise.kotlinaudio.event.PlayerEventHolder.onPlayerActionTriggeredExternally] events.
     *
     * **Example**:
     * ```
