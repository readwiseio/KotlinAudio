...
sealed class AudioItemTransitionReason(val oldPosition: Long) {
     ...
     * [QueuedAudioPlayer.next][com.readwise.kotlinaudio.players.QueuedAudioPlayer.next]
     * or [QueuedAudioPlayer.previous][com.readwise.kotlinaudio.players.QueuedAudioPlayer.previous].
     */
