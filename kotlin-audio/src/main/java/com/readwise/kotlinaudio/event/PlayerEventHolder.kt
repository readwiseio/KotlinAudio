package com.readwise.kotlinaudio.event
...
class PlayerEventHolder {
     ...
     *
     * For this observable to send events, set [interceptPlayerActionsTriggeredExternally][com.readwise.kotlinaudio.models.PlayerConfig.interceptPlayerActionsTriggeredExternally] to true.
     */
